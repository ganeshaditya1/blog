...
export default async function Page({}) {
  return <>
    <div className="flex flex-row justify-center">
      <div>
      <Image src="/profile_picture.jpg" height={1956} width={4000} alt="My profile picture." className="lg:w-64 lg:h-64 w-64 h-64 rounded-full object-cover mt-[60px] lg:mt-[0px]"/> <br/>
      ...
      <div className="ml-[10%] lg:mt-[45px] mt-[10px]">
        ...
        Email <div className="h-[0.25em] block xl:hidden"> </div> 
        ...
        LinkedIn <div className="h-[0.25em] block xl:hidden"> </div> 
        ...
        Twitter <div className="h-[0.25em] block xl:hidden"> </div>
        ...
        Current location <div className="h-[0.25em] block xl:hidden"> </div>
        </b>
