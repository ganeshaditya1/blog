...
As AWS started to grow, they were forced to build a lot of technology themselves. At times they had to innovate and create new technology from scratch. Nitro cards are one such technology. Even though AWS acquired a startup called Annapurna labs that served pivotal role in the design and development of the Nitro system, engineers at AWS contributed a lot to this technology too. This talk dives deep into the AWS Nitro system.