...
My name is Aditya Ambadipudi. I am a software engineer. I have travelled extensively around the world. I was born in India and lived here for 23 years. Then I moved to the US for my master degree and lived ther around 10 years. I also worked in the US for around 8 years. I love computers and computer science. My tryst with computers began in 3rd grade when my father bought a Cyrix computer with 64mb of ram and 8GB of hard disk space. Over the course of the last 2.5 decades I have acquired several computers. I have spent a significant chunk of my time learning the inner workings of these magical devices. Wrote software for them, some of which you might have used in the past.

I am also an avid Chess fan. I do a lot of Chess puzzles in my free time. In the past I have came across several incredibly interesting Chess puzzles and tricky positions in my games. I thought it would be interesting to share them with everyone. Which is also another reason why I choose to create this blog.
...
- Integrated this new service with the employee information system to fetch the management chain of a given employee.Used exponential backoff and caching to ensure we meet them 10 requests/second throttling limit set by the API.
- Integrated this service with people api to fetch the employee number and use that in place of employee alias and have that information be fetched before any request to this new service is processed and make it available in the context of each incoming request.
...
- Working on the Arm's reference architecture project for running high performance DPDK based networking application in a Kubernetes cluster using CNIs like Multus, Calico, SRIOV. Wored on solving several typical distributed systems problems within in this cluster like High Availability, Auto Scaling and Observability.
...
- Fixed two critical bugs in our internal forks of gRPC & DirectFB to prevent the device from crashing on exit. 
