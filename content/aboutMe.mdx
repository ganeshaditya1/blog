...
I was born in India and stayed there for 23 years. Then I moved abroad to the US and lived there for around 10 years. 
I got my masters degree in Computer Science from US. I also worked in the US for around 8 years. I love computers and computer science. 
...
Over the course of the last 2.5 decades I have acquired several computers, learnt the inner workings of these magical devices. 
Wrote software for them, some of which you might have used in the past.
...
- Primarily a backend engineer working on building the backend for the new campaign onboarding system.
- Built several of the end points in Java. The service was deployed to EKS cluster.
- Mentored junior engineers and assisted them in creating end points in this service as well.
- Integrated with internal people information APIs to pull employee information. 
...
And it is hosted on [Vercel](https://vercel.com/). All the blog posts including this page is written in MDX, which is compiled to static webpages at build time. 
[Source code of the blog](https://github.com/ganeshaditya1/blog)*
